...
[양수는 파란색, 음수는 빨간색으로 강조하는 서식]
![alt text](./Week2_Attachments/image-5.png)

[0을 하이폰(-)으로 표시하는 서식]
![alt text](./Week2_Attachments/image-6.png)

+) 0을 완전히 숨기는 경우
![alt text](./Week2_Attachments/image-7.png)

## 03-2. 실무자를 위한 셀 표시 형식 대표 예제
> **0 지우거나 하이픈[-]으로 표시하기(119 ~121p)를 진행 후 인증사진을 첨부해주세요.**
![alt text](./Week2_Attachments/image-8.png)

> **날짜를 년/월/일 [요일]로 표시하기(121 ~122p)를 진행 후 인증사진을 첨부해주세요.**
![alt text](./Week2_Attachments/image-9.png)
![alt text](./Week2_Attachments/image-10.png)

## 03-3. 깔끔한 보고서 작성을 위한 기본 규칙
> **깔끔한 보고서 완성하기(131 ~134p)를 진행 후 인증사진을 첨부해주세요.**
![alt text](./Week2_Attachments/image-11.png)
![alt text](./Week2_Attachments/image-12.png)
![alt text](./Week2_Attachments/image-13.png)
![alt text](./Week2_Attachments/image-14.png)
![alt text](./Week2_Attachments/image-15.png)
![alt text](./Week2_Attachments/image-16.png)

## 03-4. 조건부 서식으로 빠르게 데이터 분석하기
> **특정 값보다 크거나 작을 때 강조하기(137 ~139p)를 진행 후 인증사진을 첨부해주세요.**
![alt text](./Week2_Attachments/image-17.png)
![alt text](./Week2_Attachments/image-18.png)

> **조건을 만족할 때 전체 행 강조하기(141 ~142p)를 진행 후 인증사진을 첨부해주세요.**
![alt text](./Week2_Attachments/image-19.png)

> **여러 조건에 모두 만족하는 셀 강조하기(143 ~144p)를 진행 후 인증사진을 첨부해주세요.**
![alt text](./Week2_Attachments/image-20.png)
